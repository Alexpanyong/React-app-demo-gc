        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_reactRouter.Route, { exact: true, path: '/', component: _Route.Route1 }),
              _react2.default.createElement(_reactRouter.Route, { path: '/route2', component: _Route2.Route2 })
            )
          )
        )
      );
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Prompt__ = __webpack_require__(33);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Prompt", function() { return __WEBPACK_IMPORTED_MODULE_1__Prompt__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Redirect__ = __webpack_require__(34);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Redirect", function() { return __WEBPACK_IMPORTED_MODULE_2__Redirect__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Route__ = __webpack_require__(22);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Route", function() { return __WEBPACK_IMPORTED_MODULE_3__Route__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Router__ = __webpack_require__(14);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Router", function() { return __WEBPACK_IMPORTED_MODULE_4__Router__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__StaticRouter__ = __webpack_require__(36);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "StaticRouter", function() { return __WEBPACK_IMPORTED_MODULE_5__StaticRouter__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Switch__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__withRouter__ = __webpack_require__(38);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Prompt__ = __webpack_require__(33);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Switch__ = __webpack_require__(37);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_withRouter__ = __webpack_require__(38);
// Written in this round about way for babel-transform-imports
...
var _PostItem = __webpack_require__(85);
...
var Route1 = exports.Route1 = function (_Component) {
  _inherits(Route1, _Component);

  function Route1(props) {
    _classCallCheck(this, Route1);

    var _this = _possibleConstructorReturn(this, (Route1.__proto__ || Object.getPrototypeOf(Route1)).call(this, props));
    ...
    _this.sortByUserID = _this.sortByUserID.bind(_this);
    _this.getAllUserID = _this.getAllUserID.bind(_this);
    _this.setSelectedNumber = _this.setSelectedNumber.bind(_this);
    _this.showAllPosts = _this.showAllPosts.bind(_this);
    _this.alphabeticallySort = _this.alphabeticallySort.bind(_this);
    _this.showPostsByID = _this.showPostsByID.bind(_this);
    return _this;
  }
  ...
  _createClass(Route1, [{
    ...
    key: 'sortByUserID',
    value: function sortByUserID(posts, userID) {
      return posts ? posts.filter(function (post) {
        return post.userId === userID;
      }) : [];
    }
  }, {
    key: 'getAllUserID',
    value: function getAllUserID(posts) {
      if (posts) {
        var arr = posts.map(function (post) {
          return post.userId;
        });
    ...
    value: function setSelectedNumber(e) {
      var theID = parseInt(e.target.innerHTML);
      this.setState({
    ...
    key: 'alphabeticallySort',
    value: function alphabeticallySort(posts) {
      this.setState({
        showAllPosts: true,
        alphSorted: true
      });
      return !this.state.alphSorted ? posts.sort(function (a, b) {
        return a.title.substring(0, 1).toLowerCase().charCodeAt(0) - b.title.substring(0, 1).toLowerCase().charCodeAt(0);
      }) : [];
    }
  }, {
    key: 'showAllPosts',
    value: function showAllPosts(posts) {
      this.setState({
        showAllPosts: true,
        alphSorted: false
      });
      return !this.state.showAllPosts || this.state.alphSorted ? posts.sort(function (a, b) {
        return parseInt(a.id) - parseInt(b.id);
      }) : [];
    }
  }, {
    key: 'showPostsByID',
    value: function showPostsByID(posts, userId) {
    ...
    value: function render() {
      ...
      var _state = this.state,
          dataPosts = _state.dataPosts,
          showAllPosts = _state.showAllPosts,
          selectedUserId = _state.selectedUserId,
          alphSorted = _state.alphSorted;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.getAllUserID(dataPosts).map(function (item) {
              return _react2.default.createElement(
                'li',
                { key: item, onClick: _this3.setSelectedNumber },
                item
              );
            }),
            _react2.default.createElement(
              ...
              { onClick: function onClick() {
                  return _this3.showAllPosts(dataPosts);
                } },
              'Show all posts'
            ),
            _react2.default.createElement(
              'li',
              { onClick: function onClick() {
                  return _this3.alphabeticallySort(dataPosts);
                } },
              'Alphabetically sort'
            )
          )
        ...
        _react2.default.createElement(
          'ul',
          null,
          showAllPosts && !alphSorted && dataPosts.map(function (post) {
            return _react2.default.createElement(_PostItem.PostItem, { key: post.id, post: post });
          }),
          !showAllPosts && this.showPostsByID(dataPosts, selectedUserId).map(function (post) {
            return _react2.default.createElement(_PostItem.PostItem, { key: post.id, post: post });
          }),
          alphSorted && dataPosts.map(function (post) {
            return _react2.default.createElement(_PostItem.PostItem, { key: post.id, post: post });
          })
        )
      );
...
var PostItem = exports.PostItem = function (_Component) {
  ...
  _createClass(PostItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'li',
        { key: post.id, className: 'postItem' },
        _react2.default.createElement(
          'div',
          { className: 'postUserID' },
          'User ID: ',
          post.userId
        ),
        _react2.default.createElement(
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js!./PostItem.css", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js!./PostItem.css");
...
if(false) {
	module.hot.accept("!!../../../node_modules/css-loader/index.js!./Route1.css", function() {
		var newContent = require("!!../../../node_modules/css-loader/index.js!./Route1.css");
...
// module
exports.push([module.i, ".userIdList {\n    list-style: none;\n}\n\n.userIdList li {\n    display: inline-block;\n    position: relative;\n    margin: 10px;\n    padding: 6px 14px;\n    -webkit-border-radius: 24px;\n    border-radius: 24px;\n    background-color: #ececec;\n}\n\n.userIdList li:hover {\n    cursor: pointer;\n}", ""]);
...
var _newWaveKit = __webpack_require__(91);

var _newWaveKit2 = _interopRequireDefault(_newWaveKit);

var _synthOrgan = __webpack_require__(92);

var _synthOrgan2 = _interopRequireDefault(_synthOrgan);
...
var Route2 = exports.Home = function (_Component) {
  _inherits(Route2, _Component);

  function Route2(props) {
    _classCallCheck(this, Route2);

    var _this = _possibleConstructorReturn(this, (Route2.__proto__ || Object.getPrototypeOf(Route2)).call(this, props));

    _this.state = {
      sound1: null,
      sound2: null
    };
    _this.loadSound1 = _this.loadSound1.bind(_this);
    _this.loadSound2 = _this.loadSound2.bind(_this);
    return _this;
  }
  ...
  _createClass(Route2, [{
    ...
    key: 'loadSound1',
    value: function loadSound1() {
      var _this2 = this;

      fetch('https://static.bandlab.com/soundbanks//previews/new­wave­kit.ogg').then(function (response) {
        console.log("Sound 1 fetched !!!!");
        _this2.setState({ sound1: response.url });
      }).catch(function () {
        console.log("Fetch sound file 1 failed, use local file");
        _this2.setState({ sound1: _newWaveKit2.default });
      });
    }
  }, {
    key: 'loadSound2',
    value: function loadSound2() {
      var _this3 = this;

      fetch('https://static.bandlab.com/soundbanks//previews/new­wave­kit.ogg').then(function (response) {
        console.log("Sound 2 fetched !!!!");
        _this3.setState({ sound2: response.url });
      }).catch(function () {
        console.log("Fetch sound file 2 failed, use local file");
        _this3.setState({ sound2: _synthOrgan2.default });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var _state = this.state,
          sound1 = _state.sound1,
          sound2 = _state.sound2;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'li',
            { className: sound1 ? 'loaded' : '', onClick: !sound1 ? this.loadSound1 : function () {} },
            sound1 ? 'Sound 1 loaded' : 'Load Sound 1'
          ),
          _react2.default.createElement(
            'li',
            { className: sound2 ? 'loaded' : '', onClick: !sound2 ? this.loadSound2 : function () {} },
            sound2 ? 'Sound 2 loaded' : 'Load Sound 2'
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'soundTracksWrap' },
          sound1 && _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
              'span',
            ...
            _react2.default.createElement(
              'audio',
              { controls: true },
              _react2.default.createElement('source', { src: sound1, type: 'audio/ogg' })
            )
          ),
          sound2 && _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
              'span',
            ...
            _react2.default.createElement(
              'audio',
              { controls: true },
              _react2.default.createElement('source', { src: sound2, type: 'audio/ogg' })
            )
          )
        )
      );
...
module.exports = __webpack_require__.p + "76f8c68d8fa20c20ee3f4fc66c813fc2.ogg";

/***/ }),
/* 92 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "6a29d4e8093f327a3f5da3a99d3d1677.ogg";
...
// module
exports.push([module.i, ".soundList {\n    list-style: none;\n}\n\n.soundList li {\n    display: inline-block;\n    position: relative;\n    margin: 10px;\n    padding: 6px 18px;\n    -webkit-border-radius: 24px;\n    border-radius: 24px;\n    background-color: #ececec;\n    /*border: 1px solid black;*/\n}\n\n.soundList li:hover {\n    cursor: pointer;\n}\n\n.soundList li.loaded {\n    background-color: greenyellow;\n}\n\n.soundList li.loaded:hover {\n    cursor: default;\n}\n\n.soundTracksWrap > div {\n    margin: 10px;\n    padding: 0 10px;\n    -webkit-border-radius: 24px;\n    border-radius: 24px;\n    background-color: #fafafa;\n    border: 2px solid #ececec;\n}\n\n.soundName {\n    display: inline-block;\n    position: relative;\n    margin: 0 10px 0 0;\n    font-size: 14px;\n}\n\naudio {\n    vertical-align: middle;\n}", ""]);
